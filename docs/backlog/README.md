...
| [PR-05](./PR-05-editor-provider.md) | `EditorProvider` and engine lift (lands in `editor/`) | 🟢 **Merged** | AssetPanel + Preview need to live as Timeline siblings, not its children |
