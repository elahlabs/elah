...
|---|---|---|---|
| [PR-01](./PR-01-engine-invariants.md) | Engine invariants: `moveClip` + `trimClip` | 🔴 Not started | Drag/drop will exercise both functions immediately; bugs become reproducible-by-user-gesture |
